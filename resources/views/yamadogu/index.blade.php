...
<div class="container">
                ...
                <div class="card">
                   <a href="/detail/{{$product->id}}"> <img class="card-img-top img-fluid" src="{{asset($product->path)}}" alt="Responsive image"></a>
                    <div class="card-body">
                        ...
                        <small class="font-italic">{{$product->maker}}</small></h4>
    ...
    <div class="container">
        <div class="mt-5 text-center">
            <a class="btn btn-dark btn-block w-50 mx-auto" role="button" href="{{route('new')}}"><strong>新商品一覧</strong></a>
        </div>
    </div>
    <div class="container">
        <div class="text-center font-italic mt-5">
    ...
    <div class="container">
        <div class="mt-5">
            <button class="btn btn-dark btn-block w-50 mx-auto" role="button" href="#"><strong>お薦め一覧</strong></button>
        </div>
    </div>
</div>
@endsection